                        ...
                        <table style="width:100%">
                              ...
                              <tbody>
                                    ...
                                    if (isset($_GET['id_peminjaman'])) {
                                          ...
                                          $query = "SELECT dp.id_peminjaman, b.nama_barang, dp.id_barang, dp.quantity, dp.tanggal_pengembalian, dp.tanggal_peminjaman, dp.status_diambil, dp.status, u.nama_user FROM detail_peminjaman dp INNER JOIN barang b ON dp.id_barang = b.id_barang INNER JOIN user u ON dp.id_user = u.id_user WHERE dp.id_peminjaman = :id";
